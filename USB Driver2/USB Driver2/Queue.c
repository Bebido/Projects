...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, USBDriver2QueueInitialize)
#endif

NTSTATUS
USBDriver2QueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = USBDriver2EvtIoDeviceControl;
    queueConfig.EvtIoStop = USBDriver2EvtIoStop;
